...
public class Schnorr {
    ...
    public static byte[] generatePrivateKey() {
        // Generate a random 32-byte private key directly
    ...
    private static boolean isValidPrivateKey(byte[] privateKey) {
        BigInteger key = new BigInteger(1, privateKey);
        BigInteger n = new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", 16); // secp256k1 order
        return key.compareTo(BigInteger.ONE) >= 0 && key.compareTo(n) < 0;
    }
